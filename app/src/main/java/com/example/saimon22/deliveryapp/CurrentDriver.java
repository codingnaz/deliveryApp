...
public class CurrentDriver {
    private static String currentfirstName, currentmiddleName, currentlastName, currentaddress, currentpassword, currentuserName;
    private static int currentSSN,currentDOB,currentstoreID;
    ...
    public static int getCurrentDOB() {
        return currentDOB;
    }

    public static void setCurrentDOB(int currentDOB) {
